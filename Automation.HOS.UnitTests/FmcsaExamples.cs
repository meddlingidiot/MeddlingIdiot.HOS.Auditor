...
namespace Automation.HOS.UnitTests
{
    ...
    internal class FmcsaExamples
    {
        ...
        public void SetUp()
        {
            ...
            //_currentWorkingDirectory = "C:\\code\\";
        }
        ...
        public async Task Example01_14HourDrivingWindow_NoViolations()
        {
            ...
            Assert.That(violationResult.Violations.Count, Is.EqualTo(0));
        }
        ...
        public async Task Example04_DrivingLimit_WithViolations()
        {
            ...
            Assert.That(violationResult.Violations[0].Limit, Is.EqualTo(TimeSpan.FromHours(11)));
            Assert.That(violationResult.Violations[0].StartTimestamp, Is.EqualTo(DateTime.Parse("08/24/2023 14:00:00")));
            Assert.That(violationResult.Violations[0].EndTimestamp, Is.EqualTo(DateTime.Parse("08/24/2023 15:00:00")));
            Assert.That(violationResult.Violations[1].Limit, Is.EqualTo(TimeSpan.FromHours(14)));
            Assert.That(violationResult.Violations[1].StartTimestamp, Is.EqualTo(DateTime.Parse("08/24/2023 14:00:00")));
            Assert.That(violationResult.Violations[1].EndTimestamp, Is.EqualTo(DateTime.Parse("08/24/2023 15:00:00")));
        }
        ...
        public async Task Example05_RestBreaks_NoViolations()
        {
            ...
            Assert.That(violationResult.ClearViolationRange.Start, Is.EqualTo(DateTime.Parse("08/24/2023")));
            Assert.That(violationResult.ClearViolationRange.Finish, Is.EqualTo(DateTime.Parse("09/06/2023")));
        ...
        public async Task Example06_34HourRestart_NoViolations()
        {
            ...
            Assert.That(violationResult.ClearViolationRange.Start, Is.EqualTo(DateTime.Parse("08/24/2023")));
            Assert.That(violationResult.ClearViolationRange.Finish, Is.EqualTo(DateTime.Parse("09/09/2023")));
        ...
        public async Task Example07_34HourRestartMixedRest_NoViolations()
        {
            ...
            Assert.That(violationResult.ClearViolationRange.Start, Is.EqualTo(DateTime.Parse("08/24/2023 00:00:00")));
            Assert.That(violationResult.ClearViolationRange.Finish, Is.EqualTo(DateTime.Parse("09/09/2023")));
        ...
        public async Task Example08_34HourRestartMultiday_NoViolations()
        {
            ...
            Assert.That(violationResult.ClearViolationRange.Start, Is.EqualTo(DateTime.Parse("08/24/2023 00:00:00")));
            Assert.That(violationResult.ClearViolationRange.Finish, Is.EqualTo(DateTime.Parse("09/14/2023")));
        ...
        public async Task Example10_16HourDrivingWindow_WithViolations()
        {
            ...
            Assert.That(violationResult.Violations.Count, Is.EqualTo(3));
            Assert.That(violationResult.Violations[0].Limit, Is.EqualTo(TimeSpan.FromHours(14)));
            Assert.That(violationResult.Violations[0].StartTimestamp, Is.EqualTo(DateTime.Parse("8/25/2023 02:00:00")));
            Assert.That(violationResult.Violations[0].EndTimestamp, Is.EqualTo(DateTime.Parse("8/25/2023 03:00:00")));
            Assert.That(violationResult.Violations[0].TimeInViolation, Is.EqualTo(TimeSpan.FromHours(1)));
            Assert.That(violationResult.Violations[1].Limit, Is.EqualTo(TimeSpan.FromDays(7)));
            Assert.That(violationResult.Violations[1].StartTimestamp, Is.EqualTo(DateTime.Parse("8/25/2023 02:00:00")));
            Assert.That(violationResult.Violations[1].EndTimestamp, Is.EqualTo(DateTime.Parse("9/01/2023 02:01:00")));
            Assert.That(violationResult.Violations[1].TimeInViolation, Is.EqualTo(TimeSpan.Parse("07.00:01:00")));
            Assert.That(violationResult.Violations[2].Limit, Is.EqualTo(TimeSpan.FromDays(7)));
            Assert.That(violationResult.Violations[2].StartTimestamp, Is.EqualTo(DateTime.Parse("9/01/2023 02:01:00")));
            Assert.That(violationResult.Violations[2].EndTimestamp, Is.EqualTo(DateTime.Parse("9/08/2023 02:02:00")));
            Assert.That(violationResult.Violations[2].TimeInViolation, Is.EqualTo(TimeSpan.Parse("07.00:01:00")));
        }
        ...
        public async Task Example13_TwoDriverProperCarryingCmv_WithViolations()
        {
            ...
            Assert.That(violationResult.Violations.Count, Is.EqualTo(1));
            Assert.That(violationResult.Violations[0].Limit, Is.EqualTo(TimeSpan.FromHours(14)));
            Assert.That(violationResult.Violations[0].StartTimestamp, Is.EqualTo(DateTime.Parse("08/25/2023 15:00:00")));
            Assert.That(violationResult.Violations[0].EndTimestamp, Is.EqualTo(DateTime.Parse("08/25/2023 16:00:00")));
            Assert.That(violationResult.Violations[0].TimeInViolation, Is.EqualTo(TimeSpan.FromHours(1)));
        ...
        public async Task Example14_SleeperBerthUseWitRestBreak_WithViolations()
        {
            ...
            Assert.That(violationResult.Violations[0].StartTimestamp, Is.EqualTo(DateTime.Parse("08/24/2023 18:30:00")));
            Assert.That(violationResult.Violations[0].TimeInViolation, Is.EqualTo(TimeSpan.FromMinutes(30)));
            Assert.That(violationResult.Violations[0].EndTimestamp, Is.EqualTo(DateTime.Parse("08/24/2023 19:00:00")));
        }
        ...
        public async Task Example15_SleeperBerthUseNotValidSplit_WithViolations()
        {
            ...
            Assert.That(violationResult.Violations.Count, Is.EqualTo(1));
            Assert.That(violationResult.Violations[0].Limit, Is.EqualTo(TimeSpan.FromHours(11)));
            Assert.That(violationResult.Violations[0].StartTimestamp, Is.EqualTo(DateTime.Parse("08/25/2023 06:00:00")));
            Assert.That(violationResult.Violations[0].TimeInViolation, Is.EqualTo(TimeSpan.FromHours(1)));
        }
        ...
        public async Task Example16_SleeperBerthProperUse_NoViolations()
        {
            ...
            Assert.That(violationResult.ClearViolationRange.Start, Is.EqualTo(DateTime.Parse("08/24/2023 00:00:00")));
            Assert.That(violationResult.ClearViolationRange.Finish, Is.EqualTo(DateTime.Parse("09/08/2023")));
        ...
        public async Task Example21_SplitBreakWithWellTime_WithViolations()
        {
            ...
            Assert.That(violationResult.Violations.Count, Is.EqualTo(2));
            Assert.That(violationResult.Violations[0].Limit, Is.EqualTo(TimeSpan.FromHours(11)));
            Assert.That(violationResult.Violations[0].StartTimestamp, Is.EqualTo(DateTime.Parse("08/25/2023 14:30:00")));
            Assert.That(violationResult.Violations[0].EndTimestamp, Is.EqualTo(DateTime.Parse("08/25/2023 15:30:00")));
            Assert.That(violationResult.Violations[0].TimeInViolation, Is.EqualTo(TimeSpan.FromHours(1)));
            Assert.That(violationResult.Violations[1].Limit, Is.EqualTo(TimeSpan.FromHours(14)));
            Assert.That(violationResult.Violations[1].StartTimestamp, Is.EqualTo(DateTime.Parse("08/25/2023 14:30:00")));
            Assert.That(violationResult.Violations[1].EndTimestamp, Is.EqualTo(DateTime.Parse("08/25/2023 15:30:00")));
        ...
        public async Task Example23_AgriculturalOperationException_WithViolations()
        {
            ...
            Assert.That(violationResult.Violations.Count, Is.EqualTo(1));
            Assert.That(violationResult.Violations[0].Limit, Is.EqualTo(TimeSpan.FromHours(14)));
            Assert.That(violationResult.Violations[0].StartTimestamp, Is.EqualTo(DateTime.Parse("08/24/2023 22:00:00")));
            Assert.That(violationResult.Violations[0].EndTimestamp, Is.EqualTo(DateTime.Parse("08/24/2023 23:00:00")));
            Assert.That(violationResult.Violations[0].TimeInViolation, Is.EqualTo(TimeSpan.FromHours(1)));
        }
        ...
        public async Task Example27_PassengerCarryingVehicles_WithViolations()
        {
            ...
            Assert.That(violationResult.Violations.Count, Is.EqualTo(1));
            Assert.That(violationResult.Violations[0].Limit, Is.EqualTo(TimeSpan.FromHours(15)));
            Assert.That(violationResult.Violations[0].StartTimestamp, Is.EqualTo(DateTime.Parse("08/24/2023 22:00:00")));
            Assert.That(violationResult.Violations[0].EndTimestamp, Is.EqualTo(DateTime.Parse("08/25/2023")));
            Assert.That(violationResult.Violations[0].TimeInViolation, Is.EqualTo(TimeSpan.FromHours(2)));
        }
        ...
        public async Task Example28_PassengerCarryingVehicles_WithViolations()
        {
            ...
            Assert.That(violationResult.Violations.Count, Is.EqualTo(1));
            Assert.That(violationResult.Violations[0].Limit, Is.EqualTo(TimeSpan.FromHours(10)));
            Assert.That(violationResult.Violations[0].StartTimestamp, Is.EqualTo(DateTime.Parse("08/24/2023 20:00:00")));
            Assert.That(violationResult.Violations[0].EndTimestamp, Is.EqualTo(DateTime.Parse("08/24/2023 21:00:00")));
            Assert.That(violationResult.Violations[0].TimeInViolation, Is.EqualTo(TimeSpan.FromHours(1)));
        }
        ...
        public async Task Example29_60_70_HourRule_WithViolations()
        {
            ...
            Assert.That(violationResult.ClearViolationRange.Start, Is.EqualTo(DateTime.Parse("08/24/2023 00:00:00")));
            Assert.That(violationResult.ClearViolationRange.Finish, Is.EqualTo(DateTime.Parse("09/15/2023")));

            Assert.That(violationResult.Violations.Count, Is.EqualTo(1));
            Assert.That(violationResult.Violations[0].Limit, Is.EqualTo(TimeSpan.FromHours(70)));
            Assert.That(violationResult.Violations[0].StartTimestamp, Is.EqualTo(DateTime.Parse("09/01/2023 15:00:00")));
            Assert.That(violationResult.Violations[0].EndTimestamp, Is.EqualTo(DateTime.Parse("09/01/2023 16:00:00")));
            Assert.That(violationResult.Violations[0].TimeInViolation, Is.EqualTo(TimeSpan.FromHours(1)));
        }
