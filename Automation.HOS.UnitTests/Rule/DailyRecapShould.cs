...
namespace Automation.HOS.UnitTests.Rule
{
    public class DailyRecapShould
    {
        [Test]
        public void DailyRecapShouldSeparateSegementsIntoDays()
        {
            var nav = new TimelineNavigator.TimelineNavigator(new StartOfDayTimelineOptions());
            var definition = new Us60HrRuleDefinition();
            ...
            Assert.That(sut.GetValue(DateTime.Parse("03/01/2024")), Is.EqualTo(TimeSpan.FromHours(10)));
            Assert.That(sut.GetValue(DateTime.Parse("03/02/2024")), Is.EqualTo(TimeSpan.FromHours(10)));
            Assert.That(sut.GetValue(DateTime.Parse("03/03/2024")), Is.EqualTo(TimeSpan.FromHours(10)));
            Assert.That(sut.GetValue(DateTime.Parse("03/04/2024")), Is.EqualTo(TimeSpan.FromHours(10)));
            Assert.That(sut.GetValue(DateTime.Parse("03/05/2024")), Is.EqualTo(TimeSpan.FromHours(10)));
            Assert.That(sut.GetValue(DateTime.Parse("03/06/2024")), Is.EqualTo(TimeSpan.FromHours(10)));
            Assert.That(sut.GetValue(DateTime.Parse("03/07/2024")), Is.EqualTo(TimeSpan.FromHours(10)));
            Assert.That(sut.GetValue(DateTime.Parse("03/08/2024")), Is.EqualTo(TimeSpan.FromHours(10)));

        }

        [Test]
        public void CalculateTotalUsedBeforeToday() 
        {      
            var nav = new TimelineNavigator.TimelineNavigator(new StartOfDayTimelineOptions());
            var definition = new Us60HrRuleDefinition();
            ...
            Assert.That(sut.GetTotalUsed(DateTime.Parse("03/07/2024"), 7), Is.EqualTo(TimeSpan.FromHours(60)));
            Assert.That(sut.GetTotalUsed(DateTime.Parse("03/02/2024"), 7), Is.EqualTo(TimeSpan.FromHours(10)));
        }

        private void PopulateTimeline(TimelineNavigator.TimelineNavigator nav)
        {
