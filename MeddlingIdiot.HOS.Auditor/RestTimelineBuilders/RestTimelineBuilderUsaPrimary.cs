...
//-------------------------------------------------------------------------------------
            ...
            var secondaryOptions = new RestAccumulatorOptions(_ruleDefinition.SecondaryRestDutyStatuses, _ruleDefinition.MinSecondarySplitRest, _ruleDefinition.MinFullRest, ((startTimestamp, limitReachedTimestamp, finishTimestamp, driverIdNumber,
                truckNumber) =>
            {
                //Create and insert splitRestMoment.
                ...
                {
                    _navigator.Upsert(new RestMoment(startTimestamp, limitReachedTimestamp, finishTimestamp - startTimestamp, false, false, true, false, false, driverIdNumber, truckNumber));
                    _navigator.Upsert(new RestMoment(finishTimestamp, null, TimeSpan.Zero, false, false, false,false, false, driverIdNumber, truckNumber));
                }
            }));
